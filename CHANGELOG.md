...
### Fixed
- Fixed all Ruff linting errors across codebase
- Updated to use modern Python 3.10+ type annotations (`X | None` instead of `Optional[X]`)
- Updated datetime usage to use `datetime.UTC` alias instead of `timezone.utc`
- Removed unused imports and variables
- Fixed import sorting and formatting
- Removed outdated `deploy` command test (feature not yet implemented)

### Changed
- Improved code quality and consistency
- All source and test files now pass linting checks
...
[0.1.2]: https://github.com/synheart-ai/synheart-wear-cli/releases/tag/v0.1.2
[0.1.1]: https://github.com/synheart-ai/synheart-wear-cli/releases/tag/v0.1.1
